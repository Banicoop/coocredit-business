...
export const paths: Path[] = [
  ...
  },
  {
    num: "02",
    title: "Super Agent",
    role: "The Network Strategist",
    desc: "Designing complex regional networks. Oversight of multiple hubs with high-profile portfolio management.",
