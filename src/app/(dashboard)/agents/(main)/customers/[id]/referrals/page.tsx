...
import { Copy, MailIcon, MapPinCheck, Megaphone, Timer, TrendingUp, UserRoundKey } from 'lucide-react';
...
const Referrals = () => {
  return (
    <Grid className='gap-4'>
        <BackButton/>
        <PageHeader title='Referral Network' />
        <Grid className='lg:grid-cols-3 gap-4'>
            ...
            <Grid className='gap-4'>
                ...
                <GridItem className='gap-2'>
                    ...
                    <Typography variant='small' color='primary' weight='bold' className='uppercase'>Quick share</Typography>

                    <Grid className='grid-cols-3 gap-2'>
                        <Flex className='bg-accent justify-center p-2 rounded-sm'>
                            <Image src='/icons/whatsapp.svg' alt='' width={20} height={20} className='rounded-full object-cover cursor-pointer' />
                        </Flex>
                        <Flex className='bg-accent justify-center p-2 rounded-sm'>
                            <Image src='/icons/facebook.svg' alt='' width={20} height={20} className='rounded-full object-cover cursor-pointer' />
                        </Flex>
                        <Flex className='bg-accent justify-center p-2 rounded-sm'>
                            <MailIcon size={20} className='text-primary cursor-pointer' />
                        </Flex>
                    </Grid>
                </GridItem>
                <GridItem>
                    ...
                    <hr className='my-2 h-0.5 bg-[#020203]'/>
