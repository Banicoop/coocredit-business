...
type GuarantorSectionProps = LoanGuarantorProps & {
  onAddDocument?: (guarantor: Guarantor) => void;
  onRemoveDocument?: (guarantorId: string, documentId: string) => void;
};
          ...
          >
            ...
            <div className="p-5">
              <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div>
                  <p className="text-xs font-medium text-slate-400">BVN</p>
                  ...
                  <div className="mb-4 rounded-xl bg-slate-50 p-3">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {guarantor.documentsRequired.map((type) => {
                        const uploaded = guarantor.verificationDocuments?.some(
                          (doc) => doc.type === type
                        );
                  ...
                  <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                    {guarantor.verificationDocuments.map((document) => {
                      ...
                      return (
                        <div
                          key={documentId}
                          className="group flex items-center gap-3 rounded-xl border border-slate-200 p-3 transition hover:border-[#1E4FD8]/40 hover:bg-[#1E4FD8]/3"
                        >
                          ...
                          {onRemoveDocument && (
                            <button
                              ...
                              onClick={() =>
                                //@ts-ignore
                                onRemoveDocument(guarantor._id, documentId)
                              }
