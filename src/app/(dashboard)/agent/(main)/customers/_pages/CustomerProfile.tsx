      ...
      <Grid className='gap-5 md:grid-cols-3'>
        <GridItem className='md:col-span-2'>
          <FlexCol className='gap-2.5 px-4 py-3 w-full'>
            <FlexCol className='gap-4 md:flex-row md:items-center justify-between'>
              <FlexCol className='items-center justify-center md:flex-row'>
              ...
              <Link href='/agents/customers/id/referrals' className='py-2 px-4 rounded-lg bg-primary text-card font-semibold shadow-md flex items-center justify-center'>Referrals</Link>
            </FlexCol>
              <Grid className='grid-cols-2 md:grid-cols-3 gap-x-2 w-full'>
                ...
                <ColItem item1='Account' item2='-' className1='text-ink' className2='text-[#0F1C2C] font-semibold  text-[18px]'/>
                <ColItem item1='Town' item2='-' className1='text-ink' className2='text-[#0F1C2C] font-semibold text-[18px]'/>
        ...
        <GridItem className='gap-y-4'>
          ...
          <FlexCol className='h-28 w-28 flex items-center justify-center rounded-full border-4 border-primary mx-auto'>
            <Typography variant='h1'>810</Typography>
            <Typography color='active'>Excellent</Typography> 
          </FlexCol>
            <Typography color='active' className='text-center px-2 py-1 flex items-center justify-center rounded-sm bg-[#0053CC1A]'>+12 pts from last month</Typography> 
        </GridItem>
      </Grid>
