...
import { PortfolioCard } from './_sections/PortfolioCards';
import AssetLoans from './_sections/AssetLoan';
import Typography from '@/components/primitives/Typography';
import { Activity, AlertTriangle, Banknote, FileText, TrendingUp } from 'lucide-react';
    ...
    <Grid className='gap-6'>
      <PageHeader 
        ...
        <Grid className='grid-cols-2 lg:grid-cols-4 gap-4'>
          ...
          <PortfolioCard icon={<Activity size={20} color='green'/>}
            percent={3.4}
